...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Frontend assets are embedded in the web image, so frontend changes deploy web too.
        (["apps/frontend/src/App.tsx"], triggers("web", "frontend")),
        ...
        # Multiple changes
        (
            ["apps/web/main.py", "apps/frontend/src/App.tsx"],
